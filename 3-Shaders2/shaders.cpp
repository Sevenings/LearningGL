...
int main()
{
    ...
    readFile("fragShader.glsl", &fragmentShaderSource);
    ...
    // --------------------
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "OMNITRIX", NULL, NULL);
    if (window == NULL)
    {
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        int locationOurColor = glGetUniformLocation(shaderProgram, "greenTone");
